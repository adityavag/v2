    ...
    return (
        <div className=" text-justify max-lg:mt-4 col-start-2 text-[#C4BFB7]">
            ...
            <div className="lg:grid lg:grid-cols-1 content-center max-lg:flex max-lg:flex-col mb-10">
                ...
                <p className="mb-4 text-justify font-light">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo repudiandae eos alias facilis autem non dolorem nobis inventore debitis a illo earum aliquam amet, libero veritatis unde labore corporis voluptatum! Dolorem iure placeat corrupti sint id, facere mollitia quidem accusamus assumenda consequuntur voluptatum ratione officiis ipsam dolore porro magnam soluta dolor, aliquam, eius similique quod ex doloremque nostrum reiciendis! Praesentium?
                </p>
            </div>
        </div>
